// Debug script para testar SACRE com taxa 5% (original)
...
function generateSacreSchedule(principal, rate, periods) {
  ...
  for (let i = 1; i <= periods; i += 1) {
    ...
    if (i <= 3 || i === periods) {
      console.log(`Period ${i}: PMT=${currentInstallmentExact.toFixed(6)} (${installmentDisplay.toFixed(2)})`);
    }
...
// Test with 5% (original)
console.log("=== SACRE Test: Principal 10.000, Rate 5%, Periods 12 ===");
const result5 = generateSacreSchedule(10000, 5, 12);
console.log("");

// Test with 10%
console.log("=== SACRE Test: Principal 10.000, Rate 10%, Periods 12 ===");
const result10 = generateSacreSchedule(10000, 10, 12);
console.log("");

// Test with 20%
console.log("=== SACRE Test: Principal 10.000, Rate 20%, Periods 12 ===");
const result20 = generateSacreSchedule(10000, 20, 12);
